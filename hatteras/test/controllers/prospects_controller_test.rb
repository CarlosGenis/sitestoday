...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { adress: @prospect.adress, firstname: @prospect.firstname, lastname: @prospect.lastname, phonenumber: @prospect.phonenumber, state: @prospect.state, zip: @prospect.zip } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { adress: @prospect.adress, firstname: @prospect.firstname, lastname: @prospect.lastname, phonenumber: @prospect.phonenumber, state: @prospect.state, zip: @prospect.zip } }
